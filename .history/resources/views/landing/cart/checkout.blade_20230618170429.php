    ...
    <div class="w-full p-6 md:p-12 bg-gray-100 h-full">
        <div class="container mx-auto px-4">
            <div class="flex flex-col items-center justify-center gap-y-4 md:gap-y-8 text-center">
                ...
                <button
                    class="px-4 py-2 rounded-lg bg-white hover:bg-culti-green-4 text-culti-green-4 hover:text-white hover:scale-105 hover:duration-200 flex items-center gap-2 text-sm font-semibold border-2 border-culti-green-4"
                    id="pay-button">
