            ...
            <div class="flex flex-col items-center justify-center gap-y-4 md:gap-y-8 text-center">
                ...
                <div class="bg-white rounded-lg shadow overflow-hidden">
                    <table class="w-full">
                        <tbody>
                            <tr>
                                <th class="px-4 py-3 bg-slate-800 text-left text-gray-100">Invoice</th>
                                <td class="px-4 py-3">{{ $invoice->invoice }}</td>
                            </tr>
                            <tr>
                                <th class="px-4 py-3 bg-slate-800 text-left text-gray-100">User ID</th>
                                <td class="px-4 py-3">{{ $invoice->user_id }}</td>
                            </tr>
                            <tr>
                                <th class="px-4 py-3 bg-slate-800 text-left text-gray-100">Name</th>
                                <td class="px-4 py-3">{{ $invoice->name }}</td>
                            </tr>
                            <tr>
                                <th class="px-4 py-3 bg-slate-800 text-left text-gray-100">Grand Total</th>
                                <td class="px-4 py-3">{{ $invoice->grand_total }}</td>
                            </tr>
                            <tr>
                                <th class="px-4 py-3 bg-slate-800 text-left text-gray-100">Status</th>
