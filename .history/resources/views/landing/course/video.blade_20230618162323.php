        ...
        <div class="container mx-auto">
            <div class="grid grid-cols-1 md:grid-cols-12 gap-4 md:gap-4">
                <div class="col-span-12 md:col-span-7">
                    <div class="aspect-w-16 aspect-h-9 md:aspect-w-12 md:aspect-h-8 h-90 md:h-90 lg:h-60 border rounded-lg">
                ...
                <div class="flex flex-row overflow-x-auto md:grid md:grid-cols-3 gap-4 items-start">
                    @foreach ($reviews as $review)
                        <div class="min-w-full bg-slate-800 rounded-lg border border-slate-800">
                            ...
                            <div class="p-4 space-y-2 text-sm text-gray-700 border border-line border-t-slate-800 border-slate-900 bg-gray-100 rounded-b">
