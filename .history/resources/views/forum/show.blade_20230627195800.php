    ...
    <div class="max-w-7xl-auto py-6 sm:px-6 lg:px-8 bg-culti-green-4 items-center">
        <div class="sm:container sm:mx-auto px-6 rounded flex items-center justify-between mb-2">
            ...
            @if (Auth::check() && Auth::id() == $forum->user_id || 1)
                <a href="{{ route('forum.edit', $forum->id) }}" class="flex items-center space-x-4 sm:button bg-blue-600 hover:bg-blue-700 text-sm text-white font-semibold py-2 px-4 rounded">
                    <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-message w-5 h-5 md:w-6 md:h-6" viewBox="0 0 55 55" width="20" height="20">
