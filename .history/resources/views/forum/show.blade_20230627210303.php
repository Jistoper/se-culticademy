                                ...
                                <div class="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                                    <div class="items-center text-right mb-3">
                                        <button onclick="closeModal()">
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 220 220" width="20" height="20">
                                                ...
                                                0,0,1,11.3125-11.3125L128,116.6875l26.34375-26.34375a7.99915,7.99915,0,0,1,11.3125,11.3125L139.3125,128Z" fill="#000000" class="color000 svgShape"></path>
                                            </svg>
                                        </button>
                                    </div>
