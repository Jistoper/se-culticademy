...
@section('content')
    <div class="sm:container sm:mx-auto px-6 bg-culti-green-4 rounded flex items-center justify-between mb-2">
        <h2 class="text-xl font-medium">{{ $forum->forum_title }}</h2>
    ...
    <hr class="h-px my-6 bg-culti-green-3 border-none">
    <div class="bg-white">
        <div>
            <p class="text-gray-700">{{ $forum->forum_desc }}</p>
        </div>
    </div>
