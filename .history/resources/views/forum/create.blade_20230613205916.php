        ...
        <div class="sm:container sm:mx-auto px-6 bg-culti-green-4 rounded">
            <div class="px-4 py-6 sm:px-0">
                ...
                <form action="{{ route('forum.store') }}" method="POST">
                    @csrf
                    <div class="mb-1 p-2">
                        <h3 for="forum_title" class="block text-gray-200 font-semibold mb-1">Title</h3>
                    ...
                    <div class="mb-4 p-2">
                        <label for="forum_desc" class="block text-gray-200 font-semibold mb-1">Description</label>
