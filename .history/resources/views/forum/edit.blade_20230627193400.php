                ...
                <form action="{{ route('forum.update', $forum->id) }}" method="POST">
                    ...
                    <div class="-mx-3 md:flex mb-6">
                        <div class="md:w-full px-3">
                            ...
                            <input class="appearance-none block w-full bg-gray-200 text-gray-100 border @error('forum_title') border-red-500 @enderror rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" id="forum_title" type="text" placeholder="Enter forum title" name="forum_title" value="{{ $forum->forum_title }}">
                            @error('forum_title')
                                <p class="text-red-500 text-xs italic">{{ $message }}</p>
                            @enderror
                        </div>
