        ...
        <div class="px-4 py-6 sm:px-0">
            ...
            <form action="{{ route('forum.store') }}" method="POST">
                ...
                <div class="mb-1 p-2">
                    ...
                    <input type="text" name="forum_title" id="forum_title" class="form-input rounded-md shadow-sm w-50 border border-gray-300 @error('forum_title') border-red-500 @enderror" value="{{ old('forum_title') }}" required autofocus>
                    @error('forum_title')
