        ...
        <div class="container mx-auto">
            ...
            <section class="p-10 w-full">
                <div class="flex flex-col items-center justify-center p-4 space-y-8 md:p-10 md:px-24 xl:px-48">
                    <a href="#"
                        class="px-4 py-2 rounded-lg bg-white text-gray-900 text-base flex items-center gap-2 hover:scale-105 hover:duration-200 border-2 border-culti-green-3 hover:border-white">
