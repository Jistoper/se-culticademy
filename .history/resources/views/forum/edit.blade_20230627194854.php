        ...
        <div class="sm:container sm:mx-auto px-6 bg-culti-green-4 rounded">
            <div class="px-4 py-6 sm:px-0">
                <div class="flex space-x-2">
                    <svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 55 55" viewBox="0 0 55 55" width="256" height="256"><path d="M42.2,24.27c-0.55,0-1,0.45-1,1v22.96c0,1.25-1.02,2.26-2.27,2.26H6.77c-1.25,0-2.26-1.02-2.26-2.26V16.07
                        c0-1.25,1.02-2.26,2.26-2.26h22.95c0.55,0,1-0.45,1-1s-0.45-1-1-1H6.77c-2.35,0-4.26,1.91-4.26,4.26v32.17
                        c0,2.35,1.91,4.26,4.26,4.26h32.17c2.35,0,4.27-1.91,4.27-4.26V25.27C43.2,24.72,42.75,24.27,42.2,24.27z" fill="#000000" class="color000 svgShape"></path><path d="M51.64,6.02l-2.66-2.66c-1.14-1.14-3-1.14-4.15,0l-16.4,16.4c-0.11,0.11-0.2,0.25-0.24,0.4l-2.59,7.98
                        ...
                        C50.59,7.79,50.59,8.38,50.23,8.75z" fill="#000000" class="color000 svgShape"></path></svg>
