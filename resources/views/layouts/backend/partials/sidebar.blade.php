<aside class="main-sidebar sidebar-dark-primary elevation-4">
    <a href="/" class="brand-link">
        <div class="text-center">
            <span class="brand-text font-weight-bold text-grey">Culticademy</span>
        </div>
    </a>
    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                @role('admin')
                <li class="nav-header text-white">DASHBOARD</li>
                <li class="nav-item">
                    <a href="{{ route('admin.dashboard') }}" class="nav-link {{ active('admin.dashboard') }} ">
                        <svg xmlns="http://www.w3.org/2000/svg"
                            class="icon icon-tabler icon-tabler-brand-tabler nav-icon text-white text-white" width="24" height="24"
                    ...
                    <li class="nav-item">
                        <a href="{{ route('admin.category.index') }}" class="nav-link {{ active('admin.category*') }} ">
                            <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-category-2 nav-icon text-white text-white"
                    ...
                    <li class="nav-item {{ Route::is('admin.course*') ? 'menu-open' : '' }}">
                        <a href="#" class="nav-link {{ active('admin.course*') }}">
                            <svg xmlns="http://www.w3.org/2000/svg"
                                class="icon icon-tabler icon-tabler-device-laptop nav-icon text-white" width="24" height="24"
                                viewBox="0 0 24 24" stroke-width="1.25" stroke="currentColor" fill="none"
                                stroke-linecap="round" stroke-linejoin="round">
                                <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                    ...
                    <li class="nav-item">
                        <a href="{{ route('admin.showcase.index') }}" class="nav-link {{ active('admin.showcase*') }} ">
                            <svg xmlns="http://www.w3.org/2000/svg"
                                class="icon icon-tabler icon-tabler-source-code nav-icon text-white" width="24" height="24"
                                viewBox="0 0 24 24" stroke-width="1.25" stroke="currentColor" fill="none"
                                stroke-linecap="round" stroke-linejoin="round">
                                <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                    ...
                    <li class="nav-item">
                        <a href="{{ route('admin.review.index') }}" class="nav-link {{ active('admin.review.index') }}">
                            <svg xmlns="http://www.w3.org/2000/svg"
                                class="icon icon-tabler icon-tabler-message-2 nav-icon text-white" width="24" height="24"
                                viewBox="0 0 24 24" stroke-width="1.25" stroke="currentColor" fill="none"
                                stroke-linecap="round" stroke-linejoin="round">
                                <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                                <path
                    ...
                    <li class="nav-header text-white" >LEARN</li>
                        <li class="nav-item">
                        <a href="{{ route('admin.mycourse') }}" class="nav-link {{ active('admin.mycourse*') }} ">
                            <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-devices nav-icon text-white"
                            width="24" height="24" viewBox="0 0 24 24" stroke-width="1.25"
                    ...
                    <li class="nav-item">
                        <a href="{{ route('admin.transaction.index') }}"
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-receipt nav-icon text-white"
                                width="24" height="24" viewBox="0 0 24 24" stroke-width="1.25"
                                stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                                <path
                    ...
                    <li class="nav-item">
                        <a href="{{ route('admin.user.index') }}" class="nav-link {{ active('admin.user.index') }}">
                            <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-users nav-icon text-white"
                                width="24" height="24" viewBox="0 0 24 24" stroke-width="1.25"
                                stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                    ...
                    <li class="nav-item">
                        <a href="{{ route('admin.user.profile') }}" class="nav-link {{ active('admin.user.profile') }}">
                            <svg xmlns="http://www.w3.org/2000/svg"
                                class="icon icon-tabler icon-tabler-user-circle nav-icon text-white" width="24" height="24"
                                viewBox="0 0 24 24" stroke-width="1.25" stroke="currentColor" fill="none"
                                stroke-linecap="round" stroke-linejoin="round">
                                <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                ...
                @role('member|author')
                    ...
                    <li class="nav-item">
                        <a href="{{ route('member.dashboard') }}" class="nav-link {{ active('member.dashboard') }} ">
                            <svg xmlns="http://www.w3.org/2000/svg"
                                class="icon icon-tabler icon-tabler-brand-tabler nav-icon text-white" width="24" height="24"
                                viewBox="0 0 24 24" stroke-width="1.25" stroke="currentColor" fill="none"
                                stroke-linecap="round" stroke-linejoin="round">
                                <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                                <path d="M8 9l3 3l-3 3"></path>
                    ...
                    <li class="nav-header text-white">CONFIGURATION</li>
                    <li class="nav-item">
                ...
                <li class="nav-item">
                    <a href="#" class="nav-link"
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-logout nav-icon text-white"
                            width="24" height="24" viewBox="0 0 24 24" stroke-width="1.25"
                            stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
