...
<head>
  ...
  <style>
    ...
    body {
      background-image: url('{{ asset('utils/certificate-background.png') }}');
...
<body class="bg-cover bg-center bg-no-repeat flex items-center justify-center">
  <div class="max-w-md bg-white shadow-lg rounded-lg overflow-hidden">
    <div class="py-4 px-6">
      <h2 class="text-4xl font-bold mb-10 text-center mx-auto align-middle-manual mt-10" >Certificate of Completion</h2>
